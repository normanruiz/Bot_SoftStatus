...
#=============================================================================
# DESCRIPCION:
#             Este archivo incluye la definicion del modulo destiny.
#
#             Las funciones destiny permiten la manipulacion de datos en desde
#             la bases de datos que albergara los datos para reporteria.
#
#-------------------------------------------------------------------------------
...
def Recolectar(config):
    ...
    try:
        mensaje = "Cargando set de datos existente..."
        print("  " + mensaje)
        ...
        dataset = False
        mensaje = "ERROR - Cargando set de datos existente: " + str(excepcion)
        print(" ", mensaje)
        log.Escribir_log(mensaje)
        mensaje = " " + "-" * 128
        print(mensaje)
